...
- **Panelets »Opdater Sagu« bruger `kilde.js`, når den findes.** Ellers ville
  ...
  ingen bad om.
- **Knappen skifter kun filer — den genstarter ikke.** Panelet svarer 202 og
  starter ikke serveren om, så den gamle proces kører videre på ny kode, til
  du genstarter. Scriptet siger det med store bogstaver til sidst. Knappen
  tager desuden en lås, så to tryk ikke kan overlappe.
