...
| **Blokke** | Kodeblokke med kopier-knap, billeder med lightbox, tabeller, tjeklister, citater og callouts, `[[note-titel]]` med backlinks. Trækhåndtag i margenen flytter en blok, sender den til doda eller sletter den. Et billede kan kopieres for sig, og hele noten kan kopieres **med billederne indeni** |
